...
const ChatHeader = ({ setSelectedChat, user, selectedChat, isUserActive }) => {
  ...
  return (
    <div className="flex items-center px-2 h-16 border-b-[1px] border-b-gray" data-testid="chat-header">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <div className="font-medium text-base" data-testid="user-name">
              {selectedChat?.chatType === 'pdf' ? selectedChat?.chatName : sender.name}
            </div>
